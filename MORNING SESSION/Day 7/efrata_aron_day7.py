...
with open("efrata.txt", "w") as file:
    file.write("I am Efrata and i love python.\n")
    file.write("I use python for automation")

# Reading from a text file
with open("efrata.txt", "r") as file:
    content = file.read()
    print(content)
...
with open("efrata.csv", "w", newline="") as csv_file:
    writer = csv.writer(csv_file)
    writer.writerow(["name", "position", "course"])
    writer.writerow(["Efrata Aron", "Student", "BSE"])
    writer.writerow(["Hillal", "Student", "BSE"])
    writer.writerow(["M", "Student", "BSE"])

# Reading from a CSV file
with open("efrata.csv", "r") as csv_file:
...
student_data = {"name": "Efrata", "course": "BSE", "year": "Year2"}
...
student_details = {
    "Student": {"name": "Efrata Aron", "age": "25", "course": "BSE", "address": "Paris"}
}
